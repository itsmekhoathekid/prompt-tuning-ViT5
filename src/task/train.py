...
class Training:
    def __init__(self, config):
        ...
        self.optimizer = optim.AdamW(self.base_model.parameters(), lr=self.learning_rate, weight_decay=self.weight_decay)
    ...
    def training(self):
        ...
        #     ls.append(len(item['question']))
        # print("max length: ", max(ls))
